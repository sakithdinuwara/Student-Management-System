...
<main class="container mx-auto p-6">
    <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
        <h2 class="text-2xl font-semibold mb-4 text-center">Enroll Student in Course</h2>
        <form action="<%= request.getContextPath() %>/enrollments/add" method="post">
            <div class="mb-4">
                ...
                <select id="studentId" name="studentId" required
                    ...
                    <c:forEach var="student" items="${students}">
                        <option value="${student.studentId}">${student.name} (ID: ${student.studentId})</option>
                    </c:forEach>
                </select>
            </div>
            <div class="mb-4">
